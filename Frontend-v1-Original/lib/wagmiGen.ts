// Generated by @wagmi/cli@1.2.0 on 6/19/2023 at 7:24:04 PM
import {
  useContractRead,
...
export const oAggAddress =
  "0xFc1C15E43abAeAB86571582D2A36BEB32324a1a8" as const;
...
export const aggMaxxingAddress =
  "0xc98Ac135209dC7a99a4269Bd6Adc711F68A283a2" as const;
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link oAggABI}__ and `functionName` set to `"setGauge"`.
 */
export function useOAggSetGauge<TMode extends WriteContractMode = undefined>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        PrepareWriteContractResult<
          typeof oAggABI,
    ...
    : UseContractWriteConfig<typeof oAggABI, "setGauge", TMode> & {
        abi?: never;
        functionName?: "setGauge";
      } = {} as any
) {
  return useContractWrite<typeof oAggABI, "setGauge", TMode>({
    abi: oAggABI,
    address: oAggAddress,
    functionName: "setGauge",
    ...config,
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link oAggABI}__ and `functionName` set to `"setGauge"`.
 */
export function usePrepareOAggSetGauge(
  config: Omit<
    UsePrepareContractWriteConfig<typeof oAggABI, "setGauge">,
    "abi" | "address" | "functionName"
  > = {} as any
) {
  return usePrepareContractWrite({
    ...
    functionName: "setGauge",
    ...config,
  } as UsePrepareContractWriteConfig<typeof oAggABI, "setGauge">);
}
