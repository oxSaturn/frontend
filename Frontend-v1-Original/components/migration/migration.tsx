  ...
  return (
    <div className="mt-32 flex h-full min-h-[calc(100vh-432px)] w-full flex-col items-center justify-evenly gap-8 xs:mt-32 min-[1201px]:mt-0">
      <div className="flex max-w-sm flex-col gap-2 rounded-lg border border-cantoGreen bg-black p-4 tracking-wide text-green-100 md:max-w-xl">
        ...
        <div>
          In order to migrate liquidity from v1 to v2, you will need to withdraw
          your v1 LPs, convert any v1 FLOW to v2, then deposit liquidity via the
          v2{" "}
          <Link href={"/liquidity"}>
        ...
        <div>Redeeming FLOW v2 for FLOW v1 is over!</div>
      </div>
      <Paper
        elevation={0}
      ...
      >
        <div className="relative z-10 flex flex-col items-center justify-center">
          ...
          <Typography
            ...
            variant="body2"
          >
            Migration took place on 03/16 00:00 UTC.
            <br />
            If you have any questions, please contact us in the Discord.
          </Typography>
          <Button
            disableElevation
            ...
            variant="contained"
            onClick={() => window.open("https://discord.gg/yzjUSAeR", "_blank")}
          >
            <Typography>Velocimeter Discord</Typography>
          </Button>
        </div>
      </Paper>
    </div>
