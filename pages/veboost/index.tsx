      ...
      placeholder={
        <div className="relative z-10">
          ...
          <p className="my-7 mx-auto max-w-3xl text-center text-base text-secondary sm:text-lg">
            This transaction will take the amount of wFTM chosen and use it to
            market buy {GOV_TOKEN_SYMBOL}, then match it with {GOV_TOKEN_SYMBOL}{" "}
            at the rate displayed, and lock all of that in a new max locked ve
