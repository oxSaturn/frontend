        ...
        >
          ...
          <Grid item lg={12} md={12} sm={12} xs={12}>
            <Grid container spacing={2}>
              ...
              <Grid item lg={6} md={6} sm={12} xs={12}>
                <Button
                  className="relative bottom-0 min-w-full animate-titleAnim bg-background pl-3 pt-5 pr-[10px] pb-5 font-['Monument'] capitalize text-secondary delay-[400ms] max-md:float-none max-md:m-0 max-md:w-full"
                  onClick={() =>
